...
export type SupportedMimeType = "application/pdf" | "application/vnd.openxmlformats-officedocument.wordprocessingml.document" | "image/png" | "image/jpeg";
export interface ParsedDocument { text: string; needsOcr: boolean; }
...
export async function parseDocument(buffer: Buffer, mimeType: SupportedMimeType, extractors: { pdf?: PdfExtractor; docx?: DocxExtractor } = {}): Promise<ParsedDocument> {
